...
=================================================================================
Script Purpose:
    This stored procedure perfroms the ETL (Extract, Transform, Load) process to
...
BEGIN
	...
	PRINT '=====================================';
	PRINT 'Loading Silver Procedure Finished';
	PRINT '>> Silver Load Duration: ' + CAST(DATEDIFF(second, @load_start_time, @load_end_time) as NVARCHAR) + ' seconds';
	PRINT '=====================================';
	END TRY
	BEGIN CATCH
		PRINT '================================';
